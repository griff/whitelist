{
  ...
  github-pages = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0s48cjsxcig842a7v4c4as7lx7y6821b5v68fqd86kz2c84w901v";
      type = "gem";
    };
    version = "230";
  };
  ...
  html-proofer = {
    dependencies = ["addressable" "async" "benchmark" "nokogiri" "pdf-reader" "rainbow" "typhoeus" "yell" "zeitwerk"];
  };
  "http_parser.rb" = {
    groups = ["default"];
    platforms = [];
